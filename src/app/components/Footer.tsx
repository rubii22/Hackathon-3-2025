      ...
      <div className="max-w-7xl mx-auto flex flex-wrap justify-between gap-8">
        ...
        <div className="flex flex-col gap-4 min-w-[200px]">
          ...
          <div className="flex gap-4">
            <FaTwitter className="text-lg sm:text-2xl cursor-pointer hover:text-gray-400" />
            <FaFacebook className="text-lg sm:text-2xl cursor-pointer hover:text-gray-400" />
            <FaYoutube className="text-lg sm:text-2xl cursor-pointer hover:text-gray-400" />
            <FaInstagram className="text-lg sm:text-2xl cursor-pointer hover:text-gray-400" />
          </div>
        </div>
      </div>

      {/* Bottom Section */}
      <div className="mt-8 flex flex-wrap justify-between items-center gap-4 text-xs text-gray-400">
